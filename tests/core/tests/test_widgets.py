...
class ForeignKeyWidgetExportTest(TestCase):
    ...
    def test_foreign_key_widget_field_export_issue_2107(self):
        ...
        # In version 3.x, this works correctly and exports the author name
        # In later versions, this will export the ID instead
        print(f"DEBUG: exported_author_value = {exported_author_value}")
        self.assertEqual(
