...
- Modify :meth:`~import_export.widgets.ManyToManyWidget.clean` to return ``None`` instead of empty queryset (`1788 <https://github.com/django-import-export/django-import-export/issues/1788>`_)
